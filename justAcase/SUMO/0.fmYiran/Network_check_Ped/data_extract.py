...
def get_data():
    ...
    for veh in sumolib.output.parse_fast("./tripinfo_2.xml", 'tripinfo', ['id','depart','duration', 'routeLength', 'waitingTime','waitingCount','timeLoss']):
        print(veh.id)
    ...
    np.savetxt('./Simulation_data/data_stats_ph.csv', data_all, delimiter = ',')
